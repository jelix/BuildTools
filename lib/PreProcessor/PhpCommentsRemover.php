...
{
    protected static $indentation = 4;

    public static function stripComments($content, $indentation = 4)
    {
    ...
    protected static function strip_ws(&$s, &$canRemoveNextSpaces)
    {
        if ($s == '') {
            $canRemoveNextSpaces = false;
